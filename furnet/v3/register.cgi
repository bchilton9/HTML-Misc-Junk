...
$records = "/home/erenetw/public_html/furnet/v3/data";
...
print <<"END";
$head
<CENTER><BR><BR>Name: <BIG><A HREF="http://$sitename" target="_top">$sitename</a></BIG> is ready.<BR>
Return to <A HREF=http://www.furres.net>Furres.net</A>
$foot
END
...
open (MAIL, "|$mailprog $email");
			...
			print MAIL "To: $email\n";
			print MAIL "Subject: $domain sub domain\n\n";
			print MAIL "\n";
			print MAIL "Thank you for choseing $domain for your subdomain\n\n";
			print MAIL "\n";
			print MAIL "To edit your sub domain go to:\n";
			print MAIL "http://edit.furres.net\n";
			print MAIL "\n";
			print MAIL "Here is what to entered:\n\n";
			print MAIL "Sub domain: $sitename\n";
			print MAIL "Address: $location\n";
			print MAIL "Password: $password\n";
			print MAIL "Username: $username\n";
			print MAIL "Email: $email\n";
			print MAIL "Site title: $title\n";
			print MAIL "Site description: $description\n";
			print MAIL "Keywords: $keywords\n";
			print MAIL "URL hideing: $urlhideing\n";
			print MAIL "\n";
			print MAIL "URL hideing will keep $sitename in the address box on the broser allways\n";
			print MAIL "To shut this off go to:\n";
			print MAIL "http://edit.d0tt.com\n";
			print MAIL "open your site then change the \"URL hideing\" to no\n";
			print MAIL "\n";
			print MAIL "Thank you\n";
			print MAIL "Byron Chilton\n";
			print MAIL "webmaster\@$domain\n";
			close (MAIL);
